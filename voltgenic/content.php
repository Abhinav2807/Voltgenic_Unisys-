...
<table>
  ...
  $regValue = filter_input(INPUT_POST,'varname');
  $sql = "SELECT AREA_NAME,ADDRESS,PHONE, POWER_CUT, CURRENT_STATUS FROM addresses WHERE AREA_NAME ='".$regValue."' AND RECEIVED = 0;";
